...
const actionLabels: Record<string, string> = {
  ...
  "team_invitation.created": "生成团队注册链接",
  "team_invitation.revoked": "停用团队注册链接",
  "team_invitation.accepted": "使用团队注册链接",
  ...
  "project_invitation.created": "生成项目注册链接",
  "project_invitation.revoked": "停用项目注册链接",
  "project_invitation.accepted": "使用项目注册链接",
