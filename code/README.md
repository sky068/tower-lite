...
- 团队 OWNER 可在团队审计日志中按日期区间清理团队审计日志；项目 ADMIN、团队 OWNER、团队 ADMIN 可在项目审计日志中按日期区间清理当前项目审计日志。清理操作不可恢复，并会写入一条新的“清理审计日志”记录，记录清理范围和删除数量。
...
- 团队 OWNER 可以按日期区间清理团队审计日志；项目 ADMIN 或团队 OWNER / ADMIN 可以按日期区间清理项目审计日志，清理操作会追加审计记录
